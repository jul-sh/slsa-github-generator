...
export function validateGitHubFields(gho: githubObj): void {
  ...
  // https://github.com/jul-sh/github-actions-buildtypes/tree/main/workflow/v1
  // are supported.
  validateFieldAnyOf("GITHUB_EVENT_NAME", process.env.GITHUB_EVENT_NAME, [
    "create",
    // TODO(github.com/jul-sh/github-actions-buildtypes/issues/6): Revisit the deployment event type.
    // "deployment",
    "release",
    "push",
    "workflow_dispatch",
