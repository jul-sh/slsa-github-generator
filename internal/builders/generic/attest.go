...
import (
	...
	"github.com/jul-sh/slsa-github-generator/github"
	"github.com/jul-sh/slsa-github-generator/internal/builders/common"
...
run in the context of a Github Actions workflow.`,
		...
		Run: func(_ *cobra.Command, _ []string) {
			...
			if provider != nil {
				...
				// TODO(github.com/jul-sh/slsa-github-generator/issues/124): Remove
