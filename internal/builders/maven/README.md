...
Availability via
[this milestone](https://github.com/jul-sh/slsa-github-generator/milestone/17).
...
You can also release artifacts to Maven Central with [the slsa-github-generator Maven publish action](https://github.com/jul-sh/slsa-github-generator/blob/main/actions/maven/publish/README.md).
